...
int main(){
    ...
    while(1){
        ...
        for(y=0; y<=len_map; y++){
            for(x=0; x<=len_map; x++){
                if(y == carta_2_posicao_y && x == carta_2_posicao_x){
                    cout << mapa[carta_2_posicao_y][carta_2_posicao_x] << " ";
                } else{
                    cout << "# ";
                }
            }
        ...
        if(carta_1_posicao_y > len_map || carta_1_posicao_x > len_map || carta_2_posicao_y > len_map || carta_2_posicao_x > len_map){
        ...
        if(mapa[carta_1_posicao_y][carta_1_posicao_x] == mapa[carta_2_posicao_y][carta_2_posicao_x] && erro == 0){
            ...
            for(x=0; x<=len_map; x++){
                ...
                if(acertos[carta_1_posicao_y][x] == -1){
                    acertos[carta_1_posicao_y][x] = carta_1_posicao_x;
                    max += 1;
                }
                if(acertos[carta_2_posicao_y][x] == -1){
